...
<div className="bg-white h-28 border-b flex justify-center items-center gap-5 ml-12 ">
        <h2 classname="font-bold font-serif">Project-Proposal</h2>
        </div>
        ...
        <div className="max-w-6xl flex-1 mx-auto  p-6 mt-3 bg-white rounded shadow-md border-4  ">
            ...
            <h1 className="flex bg-white rounded shadow-md border-4 h-24 mb-5  font-serif">Comments /Feedback</h1>
